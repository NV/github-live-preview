...
//
  ...
  text = text.replace(/https?\:\/\/[^"\s\<\>]*[^.,;'">\:\s\<\>\)\]\!]/g, function(wholeMatch,index){
  ...
  text = text.replace(/[a-f0-9]{40}/ig, function(wholeMatch,index){
  ...
  text = text.replace(/([a-z0-9_\-+=.]+)@([a-f0-9]{40})/ig, function(wholeMatch,username,sha,index){
    if (typeof(GitHub) == "undefined" || typeof(GitHub.nameWithOwner) == "undefined") {return wholeMatch;}
  ...
  text = text.replace(/#([0-9]+)/ig, function(wholeMatch,issue,index){
    if (typeof(GitHub) == "undefined" || typeof(GitHub.nameWithOwner) == "undefined") {return wholeMatch;}
    var left = text.slice(0, index);
    var right = text.slice(index);
  ...
  text = text.replace(/([a-z0-9_\-+=.]+)#([0-9]+)/ig, function(wholeMatch,username,issue,index){
    if (typeof(GitHub) == "undefined" || typeof(GitHub.nameWithOwner) == "undefined") {return wholeMatch;}
    GitHub.repoName = GitHub.repoName || _GetRepoName()
    var left = text.slice(0, index);
    var right = text.slice(index);
